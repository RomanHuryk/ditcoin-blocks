...
#define TMPL_CSS_FRAMEWORK          TMPL_DIR "/css/iui.min.css"
 ...
 */
    ...
    public:
                  ...
                  tx_context_cache(1000)
        {
            ...
            template_file["css_framework"]      = xmreg::read(TMPL_CSS_FRAMEWORK);
                        ...
                        bool tx_prove = false)
        {
            ...
            {
                return string("Ditcoin address not provided!");
            }
            ...
            // parse string representing given ditcoin address
...
//                                << endl;
        ...
        show_checkrawtx(string raw_tx_data, string action)
        {
            ...
            else
            {
                ...
                if (strncmp(decoded_raw_tx_data.c_str(), SIGNED_TX_PREFIX, magiclen) != 0)
                {
                    ...
                    // used in myditcoin and openditcoin projects.
        ...
        search(string search_text)
        {
            ...
            // check if ditcoin address is given based on its length
            ...
            // check if integrated ditcoin address is given based on its length
     ...
     */
                     ...
                     bool tx_prove = false)
        {
            ...
            {
                j_response["status"]  = "error";
                j_response["message"] = "Ditcoin address not provided";
                return j_response;
            }
            ...
            {
                j_response["status"]  = "error";
                j_response["message"] = "Cant parse ditcoin address: " + address_str;
                return j_response;
        ...
        json_networkinfo()
        {
            ...
            {
                j_response["status"]  = "error";
                j_response["message"] = "Cant get ditcoin network info";
                return j_response;
            }
    ...
    private:
        ...
        get_footer()
        {
            ...
            static const mstch::map footer_context {
                    ...
                    {"last_git_commit_date", string {GIT_COMMIT_DATETIME}},
                    {"git_branch_name"     , string {GIT_BRANCH_NAME}},
                    {"ditcoin_version_full" , string {MONERO_VERSION_FULL}},
        ...
        {
            context["css_framework"] = mstch::lambda{[&](const std::string& text) -> mstch::node {
                return template_file["css_framework"];
            }};
